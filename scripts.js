document.getElementById('nav-toggle').addEventListener('click', function () {
    ...
    if (nav.classList.contains('collapsed')) {
        nav.classList.remove('collapsed'); // Expand the nav
    } else {
        nav.classList.add('collapsed'); // Collapse the nav
    }
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Add class to individual elements
    const elementsToShow = document.querySelectorAll('.project, .highlight, .section-title');
